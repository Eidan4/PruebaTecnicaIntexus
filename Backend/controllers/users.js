...
//     const { id } = req.params;
//     let { name, lastname, email, role, password, document, multitask,InventoryAuthorization} = req.body;
...
//     const user = await User.findByIdAndUpdate( id, { name, lastname, email, role, password, document, multitask, InventoryAuthorization}, {new: true} );
